...
Ahora para sacar el min, max, promedio y suma total de la memoria utlizada por las simulaciones se utiliza el mismo diseño anterior, buscando y realizando las sumas en la columna que correspondan a la memoria. Para luego calcular el promedio, max, min y almacenar los resultados en el mismo archivo metrics.txt. Sin olvidar eliminar los intermedios. 
